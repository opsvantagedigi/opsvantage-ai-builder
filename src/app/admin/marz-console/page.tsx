...
return (
    <div className="min-h-screen bg-[#020617] text-white font-mono overflow-hidden relative">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-0 w-125 h-125 bg-blue-900/10 blur-[100px] rounded-full" />
            </div>
            ...
            <header className="relative z-10 border-b border-white/10 bg-black/40 backdrop-blur-md p-6 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold tracking-widest text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-cyan-400">
            ...
            <main className="relative z-10 p-6 grid grid-cols-12 gap-6 h-[calc(100vh-80px)]">
                ...
                <div className="col-span-3 flex flex-col gap-6">
                    ...
                    <div className="bg-linear-to-b from-blue-900/20 to-black border border-blue-500/20 rounded-xl p-4 h-1/2">
